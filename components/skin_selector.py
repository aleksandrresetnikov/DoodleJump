...
class SkinSelectorItem(Image):
    def __init__(self, skin, item_index, site, x, y, skin_selector, **kwargs):
...
class SkinSelector:
    ...
    def append_item(self, item_index, site, x, y):
        selector_item = SkinSelectorItem(skins_list[item_index], item_index, site, x, y, self)
    ...
    def select_skin(self, index):
        ...
        self.skin_change_event(skin_name, self.settings.has_unlocked_theme(skin_name))
        return True